...
const findUserInventory = async (req, res) => {
  ...
  try {
      ...
      res.status(200).json({ allInventory: userInventory });
  } catch (error) {
...
module.exports = { CreateInventory, updateInventoryById, findUserInventory, FindInventory, ScanInventory,Deleteinventory,EditInventory,findInventoryById };
